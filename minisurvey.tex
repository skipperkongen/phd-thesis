...
% importance of maps
Since ancient times, mankind has created maps of the world based on whatever spatial information was available. Now and then, maps have been created for a plethora of purposes. From navigation, to exploration, to showing your friends on social media where you went jogging, maps communicate spatial information in an effective way.

% scale and omitting information
A geographical map will represent something as big as planet earth or a country, on something as small as a sheet of paper or a computer screen. Consequently, every person creating a map must choose what information to include and what to leave out, because there is not enough room to include everything. As a rule of thumb, maps at low scale (e.g. world maps) omit more information per square kilometer than maps at high scale (e.g. city maps). Another rule of thumb, known as the principle of constant information density, says that the amount of information per square centimeter of a map (or indeed any visualization) should remain roughly constant regardless of scale.

% scale and visual representation
There is no fixed best way to visually represent spatial information on a map. The best way depends on the scale of the map. For example, a city may be shown as a circular mark on a world map, or as a complex of roads and cities on a city map. Sometimes a distorted visual representation is appropriate, e.g. when drawing a metro train network. Sometimes it is important to draw the map in a way that close to the physical reality, e.g. when creating a mountaineering map.

% challenge
Generalization is a term that covers two processes; choosing what information to show on a map, and how to visually represent the information. Generalization is guided by the goal of simultaneously optimizing both the legibility and the accuracy of a map. In practice, there is always a trade-off involved when trying to achieve both.


As an example, a world map (low scale) omits more information per square kilometer than a map of city (high scale), because streets and buildings that are visible on the city map are not visible on the world map. On the other hand, a world map might include names of countries, which could be omitted on a city map.


The salience of pieces of information depends in a non-trivial way to scale.

When choosing what information to omit, the relevance of a given piece of information should be considered in relation to the scale of the map. For example, it might not be relevant to include the country name on a city map, while it is quite relevant on a world map.

A person creating a map must also choose how the information is depicted, for example to visually represent cities by circular dots. 


and this will vary according to the scale of the map.

% salience


Maps are usually drawn on a medium, such as a sheet of paper or a computer screen, with a limited amount of surface area. This limits the amount of information that can be communicated in a legible manner. A map creator must often sacrifice less salient information in order to make room for the essential information.




The smaller the scale of the medium, the more information must be left out.



It is not practical or even desirable to include 



This is because the surface area of the map medium is limited, whether the map is drawn on a sheet of paper or a computer screen. A computer screen consists of a finite number of pixels, which implies that a finite number of spatial information objects can be depicted on it.

.


After choosing what to include on a map, the map creator must decide how to depict the information in an informative way. The scale of the map dictates the choices that are made. A road 



This is necessary because the surface area of the map medium limitis the amount 

Furthermore, cartographers must choose how to depict the information that is included on the map. In combination, cartographers refer these two tasks as generalization.

The limited real-estate of the map medium, a sheet of paper 

Geographers call this process generalization. 


This process sacrifices less important information in order to make room for more important information 


The real-estate of maps, the sheet of paper or computer screen, is a limited resource.
