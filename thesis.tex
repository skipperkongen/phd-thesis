...
\item \textbf{Cost-effective Tiling}: 
TODO

The key question is: How can we exploit a log of previous map requests to cost-effectively serve future map requests with high performance?
\end{itemize}
