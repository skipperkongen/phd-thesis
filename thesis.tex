...
For thousands of years, humans have visualized geographic information on maps, most recently on computer screens and historically on pieces of paper and clay tablets~\cite{friendly2008milestones,robinson1982early}. During those years, maps have helped humans comprehend a multitude of spatial phenomena. For millennia, maps have helped seafarers comprehend the dangers that lie beneath the surface of the oceans and rulers understand land ownership and the basis of taxation on their territories. For example, a four-thousand-year-old clay tablet, which was discovered near present-day Kirkuk, Iraq in 1930, illustrates the boundaries of a land parcel together with the owner's name, Azala. As such, cadastral maps probably constitute one of the earliest forms of data visualization in human history. 

Over time, human knowledge of map making and the technological capacity of humans to gather geographic information has evolved hand-in-hand. All the while, Homo Sapiens, the principal maker and consumer of maps has probably -- to a large extent -- remained biologically unchanged since the Neolithic period. Consequently, modern map makers must accommodate the same limitations of visual perception in Homo Sapiens as ancient map makers. Moreover, geographic data is now accumulated at volumes so large as to be unfathomable during the Neolithic period. All the while, the map medium itself has shrunk to fit onto mobile devices that can be carried in a pocket. Hence, larger volumes of geographic data must now (potentially) be accommodated by smaller map mediums.
