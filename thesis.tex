...
\textbf{Why are Maps are Powerful?}
In middle of the 19th century, Florence Nightingale worried that her statistical findings, if presented in table form, would put Queen Victoria to sleep rather than inform about why mortality had suddently dropped in the Crimean War. Instead, she presented her statistical findings in the form of a coxcomb diagram ``to affect thro' the Eyes what we fail to convey to the public through their word-proof ears''. The key information that Nightingale wanted to convey to the Queen was that people were dying, not from their wounds, but from diseases. By looking at her coxcomb diagram, this important information jumped straight into the mind of the beholder.

This work is primarily about geographic maps, not about coxcomb diagrams. However, similar to the coxcomb diagram of Florence Nightingale, geographic maps exploit that the visual sense is keen in humans. The reasons that maps can be so effectivily comprehended by humans was first formally argued by Jacques Bertin in his seminal work on semiology~\cite{bertin1967semiologie}. While other forms of information, such as data tables, demand that information be held first in human memory before it can be processed by the brain, maps are graphics that allow spatial information to be understood at a glance. The reason that information on maps can be rapidly comprehended is that information is represented in the three dimensions that are most keenly perceived by humans: x, y and color! As such, there are deeply biological reason why maps are powerful.

\textbf{Why Should Maps be Studied?}
The former paragraphs explain why maps are powerful. However, they do not explain why maps should be studied. Map should be studied because they are both useful and (still) difficult to produce. Why a maps difficult to produce? While maps are expressed in the three dimensions (x, y, color) that humans have evolved to percieve particularly well, graphics have only three dimensions and the consequences of this limitation are important~\cite{bertin1967semiologie}. 

To understand how maps are limited by these three dimensions, it is useful to understand the concept of scale.There is a discrepancy between the scale of the map medium (e.g. a piece of paper) and the scale of information that is represented by the map (e.g. the entire World). Therefore, when trying to fit the entire World onto a piece of paper, the World must necessarily be scaled down. Representing all the information in the World by tiny symbols will not work, as symbols will quickly become imperceptible to the human eye. Conversely, keeping the size of symbols constant while increasing the number of symbols will soon result in symbol clutter. Therefore, as the amount of information grows, each symbol must either represent more information (i.e. aggregation), or information must be omitted (i.e. selection).
