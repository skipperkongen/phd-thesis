...
The background for this thesis has been the impact that the Web and cloud computing has made on the time-honored fields of multi-scale map and data visualization. We have argued that new tools for the design, processing, and distribution of map and data visualizations are necessary. Specifically, we have stated the need for new tools that can handle massive amounts of data, be operated by a new breed of non-expert designers, and ensure low-cost, low-latency, high-availability, and scalable access to data.

On this background, this thesis has made contributions in the following areas: selection of data for geographic maps and data visualizations (Subject A) and algorithms for prediction of geographic map requests (Subject B). In this section, we will review the goals and results of this thesis for each these subject areas.

\subsection{Selection: Goals and Results}

This thesis makes two contributions on the topic of selection (Subject A): The language contribution (Contribution 1) consists of two declarative languages, Glossy SQL and CVL, which allow users to express multi-scale selection for geographic maps and data visualizations. The compiler contribution (Contribution 2) consists of two compilers for these declarative languages. The compilers translate Glossy SQL and CVL into SQL and stored procedures for in-database execution of holistic selection.
