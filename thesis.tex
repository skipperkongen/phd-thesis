...
% How does the situation motivate the topic of the thesis?
Data partitioning~\cite{datacenter:as:a:computer}, data replication~\cite{datacenter:as:a:computer} and data abstraction~\cite{mapgen, dbgen} are important techniques for providing the high-quality data visualizations that users expect.
