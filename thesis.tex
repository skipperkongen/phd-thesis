...
Given an appropriately abstracted dataset, system operators must ensure that the data is delivered to applications with low latency and high availability. A crucial problem is to operate a system that reaches these goals while minimizing the cost.
