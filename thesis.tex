...
Indexing~\cite{bereuter2013real, nutanong2012multiresolution, van1995gap}. 
...
\chapter{Serving Web Maps to Large Audiences}
...
State the requirements: high-availability, high-scalability, high-performance, interactive, tiled (constraints), minimize cost (objective).
\emph{maybe state these in Introduction: problem statement, and refer to the section}.
