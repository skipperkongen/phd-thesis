...
For thousands of years, maps have provided humans with a visual way to gain spatial intelligence about the Earth. Maps visualize relevant geographic information in a legible and comprehensive way on a practical medium -- most recently on computer screens and historically on pieces of paper and clay tablets~\cite{friendly2008milestones,robinson1982early}. Maps exploit that the visual sense is keen in humans. While other forms of information, such as data tables, demand that information be held in memory and steadily processed by the brain, maps are graphics that allow information to be understood in a single glance~\cite{bertin1967semiologie}. 

Over time, maps have been created for a multitude of reasons. For example, maps have helped seafarers to master the challenge of navigation and helped rulers gain an overview of their territories. Indeed, one of the oldest use cases for maps is the registration of land ownership, which is recorded in a cadastre. For example, information about land ownership is etched into a clay tablet that was discovered near present-day Kirkuk, Iraq in 1930. The clay tablet, which is more than four thousand years old, illustrates a plot of land between two rivers together with the owner's name, Azala.

Over time, the capacity of humans to collect and record geographic information has grown explosively. Today, trillions of spatial facts have been recorded about the Earth and the rest of the Universe~\cite{openstreetmap,york2000sloan}. However, while human knowledge has grown unbounded, the capacity for visual perceptive in humans has probably remained stable since the stone age. Consequently, modern map makers must accomodate the same limitations of human visual perception as ancient map makers -- albeit while potentially communicating much larger quantities of information.
