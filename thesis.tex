...
\chapter{Multiscale Visualizations}
\section{Principles}
Mention Weibel definition. Reference woodruff and toepfer (constant information density). Reference da sarma (zoom consistency and visibility constraint). Reference samet (proximity constraint). Reference someone for topological constraints.
\section{Use cases}
\subsection{Geographical Maps}
Mention GST and their use cases (POI and place names).
\subsection{Non-geographical use cases}
Reference information cartography, data cube visualization, evolutionary timelines, social network visualization. 
\section{Data Abstraction VS Visual Abstraction}
Reference data cube paper. Reuse points and figures from ICDE 2014 presentation (what to display versus how to display). 
