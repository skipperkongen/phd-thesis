...
% EXPRESSING
\section{Programming Multi-scale Map Visualizations}
\label{related:work:expressing}

First, state the difference between data and visual abstraction~\cite{gruenreich1992atkis}. Mention that thesis focuses on data abstraction, but short piece on visual abstraction included for completeness

Next, State requirements for both: express multi-scale star and ladder, holistic selection (i.e. user-defined constraints and objectives), integrate relational data, encourage code sharing and reuse, intuitive for non-experts (constraints), maximize program clarity/minimize program length (objective).
\emph{maybe state these in Introduction: problem statement, and refer to the section}.

\subsection{Data Abstraction}

In the terminology of Gr\{"o}nreich, this is called model generalization.
...
In the terminology of Gr\{"o}nreich, this is called cartographic generalization.

Graphics stuff~\cite{jacques1967semiologie, nickerson1994visual, tufte1983visual, wilkinson2006grammar, wickham2009ggplot2}.


% PROCESSING
\section{Processing Data for Multi-scale Maps}
...
% SERVING
\section{Serving Data of Multi-scale Maps}
