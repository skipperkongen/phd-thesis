...
Given the availability of so much interesting data, more and more organizations with no strong tradition for geography (e.g. news agencies), are motivated to communicate spatial narratives using maps~\cite{nytimes2010iraq, guardian2013ananas}. As a consequence, more and more professionals will need to acquire the skills to craft map visualizations. However, demand for multi-scale maps on the web is rising faster than the number of GIS experts who know how to craft them (using traditional GIS). Narrative maps can be characterized by two extremes: highly aggregated and statistical maps~\cite{guardian2013ananas} and highly detailed and immersive maps~\cite{nytimes2010iraq}.
