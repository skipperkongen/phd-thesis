...
The key question is: what is a declarative language that allows map designers to efficiently and effectively express multi-scale selection in map visualizations?
...
The key question is: how we can leverage RDBMS technology to its full potential to scalably process multi-scale selection in map visualizations?
