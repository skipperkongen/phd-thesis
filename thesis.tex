...
\emph{How has the world changed; what is the new situation?} Geospatial data visualization (e.g. digital maps) allows people to represent the physical and abstract realities of Earth in the confined pixel-space of a computer screen. Geospatial data includes points such as the location of gas stations and hospitals; lines such as the networks of streets and rivers; polygons such as areas of lakes and countries. Driving the demand for visualization is an active eco-system of geographical data creators who produce a huge diversity of curated~\cite{gst2014digitalmapsupply} and user-contributed~\cite{openstreetmap} datasets. Every day, the data grows bigger and more detailed. For example, more than one hundred thousand new objects are added to the OpenStreetMap database each day~\cite{openstreetmap2014stats}. Indeed, the value proposition is clear: geospatial data and data visualization increases transparency, efficiency and awareness in our societies~\cite{hans:rosling, offentlige:data:i:spil, haiti:earthquake:openstreetmap}; it helps us locate places to visit~\cite{}; it helps us find our way~\cite{}; Consequently, there is an increasing demand for online map visualizations that package all this geographical information into legible, interactive, and web-accessible interfaces~\cite{mapref}. The need for online maps creates a demand for more effective and efficient methods to produce and serve maps. While the process of map creation has traditionally meant the involvement of Geographical Information Systems (GIS) and experts in those systems, a new situation exists which has significantly marginalized the need for traditional GIS. Importantly, the requirements for geospatial data visualization have shifted along many dimensions: size of data, size of audience, connectivity of audience, expressibility of map creation.
...
\section{Filtering challenge of Geospatial Visualization}
