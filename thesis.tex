...
\section{Requirements of Web Mapping}
...
Homo Sapiens, the principal designer and audience of map visualizations, has remained biologically unchanged probably for thousands of years. Even as the Web has impacted when, why and how map visualizations are created and consumed, the basic ability of humans to perceive images is fundamentally limited~\cite{bertin1973semiologie}. Consequently, maps on the Web must observe most of the well-studied principles that have govern map design on paper.

%As sections of the planet are scaled down and projected onto a screen, invariably, more data will have to be shoe-horned into a fixed-size space of pixels. As scale decreases, map designers are faced with the need to abstract the information in order to produce a legible map (see Figure~\ref{fig:raw:poi:data}). Map constraints quantify the need to abstract geographic information on a map.
