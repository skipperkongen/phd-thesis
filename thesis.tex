...
This thesis is about maps. While humans have created maps for thousands of years, there are still problems that need to be addressed. The problems that are addressed herein have been caused by the dramatic impact of the Web on the life, organization and technical capability of our species. Maps can now visualize hitherto unfathomable amounts of accumulated spatial information. Maps can reach the mobile devices of millions of people across the globe in an instant of time. Maps are no longer created only by cartographers; they are created by journalists, scientists, amateurs, aid workers and many more. The Web has opened up mapping for the masses. The mission of this thesis is to support this trend with the advent of novel techniques for map production, map distribution and data integration with the repositories of data gold that are scattered across the Web.

\minisec{Why Maps are Powerful}
In middle of the 19th century, Florence Nightingale worried that her statistical findings, if presented in table form, would put Queen Victoria to sleep rather than inform about why mortality had suddently dropped in the Crimean War. Instead, she presented her statistical findings in the form of a coxcomb diagram ``to affect thro' the Eyes what we fail to convey to the public through their word-proof ears''. The key information that was communicated by the diagram was that people were dying from diseases rather than wounds. By looking at her diagram, this important conclusion jumps into the mind through the eyes in a flash of time.
...
\minisec{Why Maps are Difficult to Produce}
The former paragraphs explain why maps are powerful. However, they do not explain why maps should be studied. While graphics are expressed in the three dimensions (x, y, color) that humans are especially adapted to percieve, graphics have only three dimensions and the consequences of this limitation are important~\cite{bertin1967semiologie}. To understand the limitations of graphics it is useful to understand the concept of scale. For practical reasons, graphics are displayed on mediums of bounded size (e.g. a piece of paper). Information must inevitably be rendered at a smaller scale as more information is included in the graphic, which is equivalent to saying that the resolution of information must be reduced. By comparison, a data table can compile unbounded amounts of information without reducing the resolution of individual information items. As data tables are typically the source of information for an information graphic, as illustrated by the case of Florence Nightingale and her compiled data on mortality, a graphic must somehow reflect the data in tables. However, as a data table grows it places considerable strain on a corresponding graphic, unless the amount of data in the table can be neatly reduced without loosing too much information in the graphic. 
