...
\minisec{Operators}
The logical state of a map can be altered by performing abstract operations -- i.e. selection, projection and aggregation -- on the geographic objects and symbols. Each of the three abstract operations can be implemented by several concrete algorithms:
