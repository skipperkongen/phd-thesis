...
Research in K-V stores is searching for the right trade-off with the capabilities of relational database systems. Important areas include consistency models, programmability, indexing, bla bla bla. \emph{at some point, we will present our contributions for closing this gap, specifically in the area of data visualizations}.
