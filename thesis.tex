...
Quadtrees~\cite{bereuter2013real} , nutanong2012multiresolution, van1995gap}. 

\subsection{Advantages and Drawbacks}
% advantages
Advantage: not storing multiple representations, reparameterization, fast one-off queries, highly suitable for situations that involve a single GIS operator.

% drawbacks
Drawbacks: not optimized across queries, although this is not a fundamentally problem as witnessed by seminal studies of self-adjusting data structures~\cite{tarjan1985selfadjusting}. require online query processors that are harder to scale, significant repetition of work. Hard to perform data partitioning, although distributed spatial indexing techniques have been developed recently~\cite{paralleluniverse2012spacebase}.
...
\subsection{Advantages and Drawbacks}
% advantages
Batch-orientied: sarma2012fusiontables
...
Conclusion: O(log n) is too slow for maps on the web, need O(1) and ability to scale infinitely using data partitioning and data replication techniques.
