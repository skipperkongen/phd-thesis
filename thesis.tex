...
\item \textbf{Formal Selection Model} 

OK, this one is tricky... what is the problem that contribution 1 solves?

The problem that must be addressed is how ...?
...
The main issue with these approaches is the level of specification needed to get the job done, which is either too little or too much to be useful for selection in geographical mapsh-ups. Ideally, designers should specify just the high-level constraints and objectives for a map in a versatile and concise specification language, while leaving the minute selection of data to the system~\cite{meliou2011reverse}. Declarative languages, such as SQL, fit the bill for such as language. However, there is a lack of declarative langauges that can express multi-scale selection for map visualizations.

The key question is: what is a declarative language that allows map designers to concisely express multi-scale selection for map visualizations?
...
%Short something about how the problems stated in Section~\ref{sec:introduction:problem:statement} are addressed.
 ...
 \subsection{Multi-scale Selection Model}
