...
Glossy and CVL compilers target a spatial database managment system engine and its query language SQL with spatial UDFs. Other spatial analytics systems or query languages could have been targeted.

\subsection{Systems}

Other scalable options include Parallel Databases, such as Greenplum, Oracle Spatial, Vertica?

Other scalable options include Cluster Computing Systems, such as SpatialHadoop and HadoopGIS.

\subsection{Query Languages}

MapReduce with UDFs
SQL or related, such as Pig Latin/Pigeon with UDFs





\subsection{Analytics Programming Languages}


Compiler targets scalable spatial analytics systems, which include 
