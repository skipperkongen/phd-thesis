...
This thesis is dedicated to my son Morgan, the older brother, and my daughter Athena, the little sister who was born a year into the PhD project.
...
The purpose of this chapter is to convince a critical reader that the contributions of this thesis are sensible and furthermore that important gaps in map visualization have been closed. This chapter must be read with an understanding of the challenge that is addressed, namely the challenge of creating geographical mash-ups for the web. In constrast, previous work has probably addressed the major challenges of creating political, physical, topographic, and road maps, which is evident by the abundance of high-quality maps or ``background``maps found online. 

\section{Principles of Map Generalization}

The field of map generalization certainly rests on sound understanding of the human visual cognition process. While many generalization operators have been proposed in the literature, this thesis suggests that multi-scale selection adequately supports the majority of use cases for map visualizations on the web. To back up this claim, multi-scale selection must be evaluated in the context of well-known principles from the map generalization literature. This section reviews the most important principles.
