...
Did Kraska wait with raising issue to this section? Maybe the issues are raised earlier, and the really crisp problem definition is given here?

\begin{itemize}
\item High operations cost of data visualization systems
\item Difficulty of data reduction for visualizations 
\end{itemize}
...
\label{sec:related:work:generalization}
\begin{itemize}
...
Take Anders' write-up (if I can find it). Either attribute or paraphrase. Probably paraphrase and do not forget to thank him in acknowledgements.
\subsection{The Importance of Public Data}
Cite offentlige data is spil, etc.

\section{The Digital Map Supply Today}
Current sitiation. Value created, Operations, 
\subsection{Requirements}
\subsection{A Look Under the Covers}
\subsection{Operations in Charts and Numbers}
