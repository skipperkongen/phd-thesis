...
\title{Declarative Multi-scale Data Abstraction and Scalable Serving of Spatial Datasets}
...
\part{Declarative Multi-scale Data Abstraction}
\input{chapter-related-abstraction}
\input{chapter-cvl}
\input{chapter-cvl2}
%\input{chapter-mdal}
\part{Scalable Serving of Spatial Datasets}
\input{chapter-related-serving}
\input{chapter-tileheat}
