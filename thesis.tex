...
The web has transformed the activity of map visualization. First, the crowd of map designers has changed, from a few GIS specialists to many data entusiasts~\cite{hanrahan2012enthusiast}. Second, the data has changed, from moderately-sized, rarely updated, and locally available datasets to huge, highly dynamic, and globally available datasets. Third, the audiences of map visualizations have changed, from a few people who interacted with mapping systems mainly during business hours, to millions of people who interact with mapping systems 24 x 7 and on the go. Fourth, the purpose of mapping has changed, from being mostly a professional activity, to being simultaneously a professional, personal and social activity. These changes have caused important new problems that are not adequately addressed by state-of-the-art geographical information systems (GIS). 
