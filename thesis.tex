...
\section{Pipelines for Geographical Maps}
...
\section{Design Objectives and Principles for Geographical Maps}
...
\item \emph{Maximize spatial fullness}. Implemented by SMCP.
...
Place name implies that we must support star approach as well as ladder approach (se email med Flemming).
