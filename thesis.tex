...
Instead of presenting a complete batch-oriented web mapping pipeline, the following contributions address the important gaps that were identified in Section~\ref{sec:introduction:problem:statement}.
...
\vspace{-2ex}
\begin{itemize}
\item The first and second contributions are described in Chapter~\ref{chapter:cvl}.
\item The third contribution is described in Chapter~\ref{chapter:glossy}.
...
Section~\ref{sec:introduction:problem:statement} argued the need for a declarative language in which map designers can specify selection of geographic information for maps. This section introduces the declarative language contributions of this thesis: Glossy SQL
