...
Use ZURICH_NOTES.txt as a list of requirements for what became Glossy.
...
\section{Generalized Data Abstraction Theory}
Simply, transfer all terms and ideas from map generalization to data general data abstraction by removing specific spatial terms from the descriptions.

\minisec{Geographical data}
From a source map, compute a target map such that...
\minisec{Relational data}
