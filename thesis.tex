...
Digital map visualization studies how the geography of Earth can be represented on a computer screen. The three dimensions of a digital image make the visual perception our most powerful perceptive system, however, images are finite and have only three dimensions and the consequences of these limits are important~\cite{bertin1973semiologie}. No doubt, it is fundamentally challenging to represent something as enormous as planet Earth on something as small as a computer screen~\cite{dillard1974pilgrim}.
...
Currently, batch-oriented approaches belong to two categories, either fully automatic systems~\cite{sarma2012fusiontables} or very advanced and domain-oriented systems~\cite{lamy1999application, ware2003generalization_sa}. % Yeah, what is wrong with that?
