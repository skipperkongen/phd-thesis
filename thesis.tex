...
A MVMS must be \emph{scalable} both in the size of data~\cite{lins2013nanocubes, Im2013visreduce, battle2013scalar, liu2013immens} and the size of the audience~\cite{viegas2007manyeyes}. Todays users on the web expect acceptable latency for an application, and 24 x 7availability~\cite{google2010latency, amazon2010latency}. Additionally, it is crucial that designers can craft visualizations using MVMS interfaces that are both intuitive, efficient (in terms of wall-clock time) and can express multi-scale holistic selection.
...
% EXPRESSING
\section{Programming Multi-scale Selection}
\label{related:work:expressing}
