...
It is important to understand the requirements for each stage in the pipeline. This allows us to test for gaps between state-of-the-art pipelines and a hypothetical pipeline that meets all of the requirements.
