...
\subsection{Authoring Maps}
\minisec{Designer Requirements}
Time-efficient and Intuitive
Multi-scale
Data Abstraction (constraints and objectives)
Visual Abstraction

\minisec{Processing Requirements}
Scalability
Data Integration
Low Cost

\subsection{Serving Maps}

\minisec{User Requirements}
Besides HQ maps...
High Availability
High Scalability
Customizability

\minisec{Provider Requirements}
Low Cost
...
\item \textbf{Data Integration} TODO
