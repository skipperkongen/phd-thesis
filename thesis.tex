...
First, state the difference between data and visual abstraction~\cite{gruenreich1992atkis}. 

Next, State requirements for both: multi-scale star and ladder, user-defined constraints, salience, integrate relational data, encourage code sharing and reuse (constraints), intuitive and time-efficient for non-experts (objective).
