...
There are two types of projections: topographical (e.g. mountain map) and topological (e.g. subway map).

% Two types of data types
Two types of data types: raster and vector. Two subtypes of raster: orthophoto and grid data. Three subtypes of vector: points, lines and polygons.
