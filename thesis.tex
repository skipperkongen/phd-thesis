...
For thousands of years, humans have used their visual senses to comprehend geographic information on maps. Humans have learned early on that legible maps enables instant comprehension of relevant geographic information, while cluttered maps inhibits such comprehension. Over time, the reasons that maps are created and the context they are created in have constantly evolved. Accordingly, novel methods for drawing maps have been invented, studied, and sometimes discarded. However, there exists no evidence to suggest that the human capacity for visual perception and comprehension has evolved significantly since the stone age. Consequently, modern map makers must accomodate the same cognitive limitations in humans as ancient map makers.
