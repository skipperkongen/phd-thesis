...
\chapter{Unified Data Abstraction Theory}
\label{chapter:related:work}

\begin{itemize}
\item Cover basic concepts from Map Generalization
\item Idea: Simply transfer all terms and ideas from map generalization (operators, data types) to a general data abstraction framework by removing specific spatial terms from the descriptions.
\end{itemize}

% Once I choose the title, adjust the related work accordingly.
\section{Related Work}
\subsection{Geography: Map Generalization}
\label{sec:related:work:map:generalization}
...
\section{Unified Data Abstraction Framework}
