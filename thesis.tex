...
\subsection{Reverse Data Management}

Reverse Data Management~\cite{meliou2011reverse}
...
Google Fusion Tables~\cite{google2014fusiontables}, scalable data processing, scalable data serving, intuitive visual abstraction interface, however non-configurable data abstraction interface.
CartoDB~\cite{cartodb2014cartodb}. \emph{move to related work, 

\subsection{Data Visualization Management Systems}

Tableau~\cite{wesley2011tableau}
Ermac~\cite{wu2014case}
Scalar (don't know the short-comings).
