...
% Maps need no introduction. But what is new in the world of maps?
On the web, an eco-system of geographical data providers produce a huge diversity of curated~\cite{gst2014digitalmapsupply} and user-contributed~\cite{zooniverse2014oldweather} datasets. As networked mobile devices have become deeply integrated into the modern life style, millions of people have gained the ability to interact with map visualizations 24 x 7 and on the go. Maps extend the spatial intelligence of humans; maps enhance our in-born ability to locate places, navigate and reason about the environment. For these reasons, maps are increasingly used by organizations without strong geographical traditions to communicate geographical naratives.
