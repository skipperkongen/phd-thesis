...
This thesis focuses on generalization of geographic data in relational databases. Map generalization is a big and complex field, which on record has been studied for decades. Off the record, it has probably been studied for thousands of years. Consequently, there is a lot of related work. However, the purpose of this section is not to give a comprehensive overview of map generalization, as this is too big an area. For that, the reader is refered to the survey by Weibel and Dutton~\cite{weibel1997generalization}, as well as a paper by Jones and Ware~\cite{jones2005webage}. A recent book by Mackaness, Ruas, and Sarjakoski attempts to collect the state of knowledge in generalization as of 2011~\cite{mackaness2011generalisation}. As yet, there seems to be a lack of surveys that investigates the recent challenges and approaches in map generalization, while also relating broadly the recent work in modern data visualization. While these sources will not give a accurate impression of where generalization is going, it will give a good impression of where generalization has come from.
