...
\subsection{In-Database Map Generalization}
...
%\subsection{Batch-oriented}
%\subsection{Interactive}
%Discard this categorically for reasons a, b, c.

% FORMAT:
% section{FIELD}
% RELEVANCE TO MAP VISUALIZATION
% subsection{CONTRIBUTION} plus-minus. First subsections are DISCARDED areas
% subsection{CONTRIBUTION} plus-minus. Last subsection ACCEPTED area.
...
\subsection{Real-time vs. Batch-oriented}

wang2014efficient

Real-time: indexing~\cite{bereuter2013real, nutanong2012multiresolution, van1995gap, }. Primary advantage: not storing multiple representations, reparameterization. Primary drawbacks: require online query processors that are harder to scale, identical queries are reprocesses, slow.
