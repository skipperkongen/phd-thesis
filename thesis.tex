...
The field of map generalization certainly rests on a sound understanding of the human visual cognition process. While many generalization operators have been proposed in the literature, this thesis suggests that one is more important in the context of geographical mash-ups, namely multi-scale selection. To back up this claim, multi-scale selection must be evaluated in the context of well-known principles from the map generalization literature, to test whether it mets the requirements. This section reviews the most important principles and design objectives that have been formulated in the map visualizatoin and generalization literature.
...
\subsection{Design Objectives for iOS6 Maps}
