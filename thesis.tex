...
Given the availability of so much interesting data, more and more organizations, such as news agencies~\cite{nytimes2010iraq,guardian2013ananas}, are motivated to communicate spatial narratives using maps. As a consequence, more and more professionals will need to acquire the skills to craft map visualizations. However, demand for maps on the web is rising faster than the number of GIS experts who know how to craft them (using traditional GIS). These maps can be characterized by the extremes of highly aggregated and statistical maps~\cite{guardian2013ananas} and highly detailed and immersive maps~\cite{nytimes2010iraq}. While the former are straightforward to produce by employing basic statistics, the latter present a fundamental challenge to map designers. 
