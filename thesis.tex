...
Map visualization studies how the geography of the Earth can be displayed, most recently on computer screens and historically on pieces of paper. Since ancient times, the requirements for this process have been to legibly represent as much as possible of the relevant information in a restricted medium~\cite{jones2005webage,weibel1997generalization}. Naturally, a map must trade-off acurate representation of data that intersects the viewport (geographic boundary of the map) with data abstraction, which may omit, modify or aggregate map objects in order to increase the legibility and usefulness of the map. This process is known as \emph{map generalization}~\cite{harrie2007modelling,mackaness2011generalisation,weibel1997generalization}.
