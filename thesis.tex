...
\item \textbf{CVL}: The Cartographic Visualization Language (CVL) is a declarative programming language for global selection of spatial data for multi-scale maps. It supports user-defined constraints, user-defined object weights and ladder-based map generalization (i.e. zoom-consistency). The syntax and informal semantics of CVL are described in detail in Chapter~\ref{chapter:cvl}.

\item \textbf{Glossy SQL}: The global-selection extension to SQL (Glossy SQL) is a declarative language for global selection of n-dimensional data for multi-scale data visualizations.  It expands on the CVL language in the following ways: it generalizes global selection for both spatial and non-spatial data; it formalizes the classes of user-defined constraints into unary, binary, set and cross-scale constraints; it supports both ladder-based and star-based approaches to perform multi-scale data visualization; it allows users to define the notion of scale as a set of user-defined scale tuples; it allows scale-dependent, context-independent projection of selected objects. The semantics of Glossy SQL are given by a mapping to pure SQL. Glossy SQL is covered in in Chapter~\ref{chapter:glossy}. 
