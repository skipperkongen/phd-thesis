...
% EXPRESSING
\section{Expressing Multi-scale Map Visualizations}
\label{related:work:expressing}

State the difference between data and visual abstraction~\cite{gruenreich1992atkis}. State requirements for expressing both.
...
% PROCESSING
\section{Data Processing for Multi-scale Maps}
...
% SERVING
\section{Serving of Multi-scale Maps}
