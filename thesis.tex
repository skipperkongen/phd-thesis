...
First, while batch-oriented solutions need more storage, disk space have become the cheapest resource to scale in cloud infrastructures. Furthermore, in-memory storage architectures, such as RAMCloud~\cite{ousterhout2011ramcloud}, have become feasible and highly resilient to failure.
