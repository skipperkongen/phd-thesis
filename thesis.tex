...
In conclusion, batch-oriented generalization is the only viable option for web mapping pipelines that target large Web audiences. However, it suffers from one significant drawback that must be tolerated, namely that it is cumbersome to customize the selection information based on individual user preferences.
